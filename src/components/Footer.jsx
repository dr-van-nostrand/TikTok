...
let LoggedInFooter = () => (
  <FooterContainer>
    ...
    <Link to="/users/miperfil"> Perfil </Link>
  </FooterContainer>
);
...
let LoggedOutFooter = () => (
  <SimpleFooterContainer>
    <Routes>
      <Route path="/users/register" element={<p>¿Ya tenes Cuenta? <Link to="/users/signin">Inicia Sesion</Link> </p>}></Route>
      <Route path="/users/signin" element={<p>No tenes Cuenta? <Link to="/users/register">Crea una Cuenta</Link> </p>}></Route>
